...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nameinput" type="text" placeholder="Enter Guard Name Here" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="addinput" type="text" placeholder="Enter Address Here" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="b_no" type="text" placeholder="0000-9999" class="form-control input-md">
...
<!-- Password input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="newpassword">Register Password: </label>
  <div class="col-md-4">
    <input id="passwordinput" name="newpassword" type="password" placeholder="New password" class="form-control input-md">
  </div>
</div>
