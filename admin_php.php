...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="noinput" type="text" placeholder="New Admin Name" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="passinput" type="text" placeholder="New Admin Password" class="form-control input-md">
