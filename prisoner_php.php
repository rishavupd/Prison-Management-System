...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="noinput" type="text" placeholder="0000-9999" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nameinput" type="text" placeholder="Prisoner Name" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="a_date" type="text" placeholder="YYYY-MM-DD" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="addinput" type="text" placeholder="Address" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="crimeinput" type="text" placeholder="Comitted Crime" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="c_no" type="text" placeholder="0000-9999" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="d_imp" type="text" placeholder="Eg: 2 months or 6 years" class="form-control input-md">
