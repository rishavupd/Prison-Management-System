...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nameinput" type="text" placeholder="Cleaner Name" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="d_date" type="text" placeholder="YYYY-MM-DD" class="form-control input-md">
